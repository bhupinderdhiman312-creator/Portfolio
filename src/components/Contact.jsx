  ...
  return (
    ...
    <div className='w-full flex flex-col md:flex-row justify-evenly items-center bg-gray-950 gap-10 px-4 py-10'>
      ...
      className='w-full md:w-[600px] border border-gray-500 rounded-2xl p-4'>
        ...
        <input type="text" placeholder='Enter Your Name' className='h-10 w-full border border-blue-300 hover:scale-103 rounded-xl px-2'/><br /><br />

        <p className='font-bold text-lg md:text-2xl text-white'>Enter Your Last Name:</p>
        <input type="text" placeholder='Enter Your Email' className='h-10 w-full border border-blue-300 hover:scale-103 rounded-xl px-2'/><br /><br />

        <p className='font-bold text-lg md:text-2xl text-white'>Enter Your Email Address:</p>
        <input type="text" placeholder='Enter Your Subject'className='h-10 w-full border border-blue-300 hover:scale-103 rounded-xl px-2'/><br /><br />

        <p className='font-bold text-lg md:text-2xl text-white'>Message</p>
        <input type="text" placeholder='' className='h-20 w-full border border-blue-300 hover:scale-101 rounded-xl px-2'/><br /><br /><br />

        <button className='rounded-3xl h-12 w-40 bg-blue-500 hover:bg-blue-700 hover:scale-104 border border-blue-500 text-white font-bold'>
          Send Message
        </button>
