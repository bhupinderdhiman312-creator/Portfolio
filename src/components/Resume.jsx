...
function Resume() {
  return (
    <div
      className="w-full h-screen flex flex-col items-center justify-center p-4 md:p-6 bg-gray-950 bg-cover bg-center"
    ...
    >
      ...
      >
        <a
        href={resumePDF}         
        className="p-3 w-20 text-white border border-sky-500 rounded-2xl hover:bg-sky-400 hover:-translate-y-1 font-bold text-center"
        >
          Open
        </a>
